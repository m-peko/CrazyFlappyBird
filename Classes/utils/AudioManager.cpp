...
void AudioManager::playBackgroundMusic(const std::string& filePath, bool loop = true, float volume = 1.0)
{
#if USE_AUDIO_ENGINE
...
void AudioManager::playSoundEffect(const std::string& filePath, float volume = 1.0)
{
    if (soundEnabled)
    {
#if USE_AUDIO_ENGINE
